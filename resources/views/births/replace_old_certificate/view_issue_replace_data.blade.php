...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <form method="post" action="{{url('birth-certificates/replace/issue/search-byentry-number',$ddata->TrackerID)}}">
...
{{--        </div>--}}
    ...
    @if($is_result)
        <div class="col-md-12">
            ...
            <form action="{{url('birth-certificates/replace/issue-approve',$ddata->TrackerID)}}"  method="post">
