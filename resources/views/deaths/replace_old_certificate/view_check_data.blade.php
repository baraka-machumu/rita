...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <form method="post" action="{{url('birth-certificates/replace/search-byentry-number')}}">
            ...
            <a href="{{url('birth-certificates/replace/return',$vdata->TrackerID)}}" class="btn btn-success">Return</a>
