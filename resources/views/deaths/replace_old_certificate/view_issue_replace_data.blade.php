...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <form method="post" action="{{url('death-certificates/replace/issue/search-byentry-number',$ddata->TrackerID)}}">
    ...
    @if($is_result)
        <div class="col-md-12">
                ...
                @if($result)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{url('death-certificates/replace/view/1')}}" class="btn btn-sm btn-info"><i class="fa fa-eye"></i></a>
            ...
            <form action="{{url('death-certificates/replace/issue-approve',$ddata->TrackerID)}}"  method="post">
                ...
                <div class="form-group">
                    ...
                    <a href="{{url('death-certificates/replace/return',$ddata->TrackerID)}}" class="btn btn-success">Return</a>
