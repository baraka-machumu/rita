...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <form method="post" action="{{url('death-certificates/replace/search-byentry-number',$ddata->TrackerID)}}">
    ...
    @if($is_result)
        <div class="col-md-12">
            ...
            <form action="{{url('death-certificates/replace/verify',$ddata->TrackerID)}}"  method="post">
