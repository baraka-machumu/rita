...
<!-- Modal -->
<div class="modal fade" id="check-death-correct-data-duplicate-cert" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="col-md-6">
                    <table class="table table-striped table-condensed table-custom">
                        ...
                        <tr>
                            <th>Date Of Birth</th><td>{{$result->DOD}}</td>
                        </tr>
