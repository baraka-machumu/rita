...
<div class="row" style="margin-top: 20px;">
    ...
    <div class="col-md-12">
        ...
        @endif
        <table class="table table-bordered table-striped table-death-request-correction" id="datatable">
            ...
            @foreach($issues as $index=>$myTaskDuplicate)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{url('death-certificates/correction/view-issue-request',$myTaskDuplicate->TrackerID)}}" class="btn btn-sm btn-info"><i class="fa fa-eye"></i></a>
