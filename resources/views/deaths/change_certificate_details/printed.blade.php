...
<div class="row" style="margin-top: 20px;">
    ...
    <div class="col-md-12">
        ...
        <table class="table table-bordered table-striped table-search" id="datatable">
            ...
            @foreach($printed as $index=>$myTaskDuplicate)
                <tr>
                    <td>{{$index+1}}</td>
                    ...
                    <td>
                        ...
                        <a href="{{url('birth-certificates/correction/view-issue-request',$myTaskDuplicate->TrackerID)}}" class="btn btn-sm btn-info"><i class="fa fa-eye"></i></a>
